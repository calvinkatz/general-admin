...
This file combines the MaintenanceSolution.sql from OLA Hallengren with other functions
to setup a complete backup, index maintenance, and integrity check for SQL Server.

The script does the following:
* Installs OLA Hallengren's stored procedures for backup/maintenance
* Enables and configures database mail for alerting
* Adds serverteam@domain.com as an Operator for database mail. (Lines 4987, 5069, 5095)
* Adds SQL Agent jobs for backup/maintenance (Lines 5112, 5248, 5332, 5411, 5490)

Jobs are as follows:
* MAINT Nightly Full - 12:00AM Full Backup, every day
* MAINT Hourly Diff - Hourly from 1:00AM to 11:59PM, every day
* MAINT 15m Log - Every 15 minutes from 1:15AM to 11:59PM, every day
* MAINT Index Optimize - Index maintenance every Saturday at 8:00AM
* MAINT Integrity Check - Check DB integrity every Sunday at 8:00AM

Backups are pointed to (Line 57): \\backupshare.domain.com\sql\<server_name>

Run script on SQL server to install.
...
SET @BackupDirectory     = N'\\backupshare.domain.com\sql' -- Specify the backup root directory.
...
-------------------------------------------------------------
--  Database Mail Simple Configuration
-------------------------------------------------------------
...
-- Profile name. Replace with the name for your profile
        SET @profile_name = 'Domain Profile';

-- Account information. Replace with the information for your account.

		SET @account_name = 'DomainMail';
		SET @SMTP_servername = 'smtp.domain.com';
		SET @email_address = 'database@domain.com';
...
USE [msdb]
GO
EXEC msdb.dbo.sp_add_operator @name=N'Server Team', 
		@enabled=1, 
		@pager_days=0, 
		@email_address=N'serverteam@domain.com'
GO
...
USE [msdb]
GO
EXEC master.dbo.sp_MSsetalertinfo @failsafeoperator=N'Server Team', 
...
GO
EXEC master.dbo.xp_instance_regwrite N'HKEY_LOCAL_MACHINE', N'SOFTWARE\Microsoft\MSSQLServer\SQLServerAgent', N'DatabaseMailProfile', N'REG_SZ', N'Domain Profile'
GO
EXEC msdb.dbo.sp_set_sqlagent_properties @email_save_in_sent_folder=1
GO

-------------------------------------------------------------
--  Add Index Optimize Job
-------------------------------------------------------------
USE [msdb]
GO
DECLARE @jobId BINARY(16)
EXEC  msdb.dbo.sp_add_job @job_name=N'MAINT Index Optimize', 
		@enabled=1, 
...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'MAINT Index Optimize', @server_name = @@SERVERNAME
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Index Optimize', @step_name=N'Index Optimize SYSTEM', 
		@step_id=1, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Index Optimize', @step_name=N'Index Optimize USER', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_fail_action=2, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'MAINT Index Optimize', 
		@enabled=1, 
		@start_step_id=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		...
		@category_name=N'Data Collector', 
		@owner_login_name=N'sa', 
		@notify_email_operator_name=N'Server Team', 
		@notify_page_operator_name=N''
GO
USE [msdb]
GO
DECLARE @schedule_id int
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'MAINT Index Optimize', @name=N'MAINT Index Optimize', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=64, 
		@freq_subday_type=1, 
...
GO
DECLARE @jobId BINARY(16)
EXEC  msdb.dbo.sp_add_job @job_name=N'MAINT Integrity Check', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		@notify_level_page=2, 
...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'MAINT Integrity Check', @server_name = @@SERVERNAME
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Integrity Check', @step_name=N'Integrity Check SYSTEM', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_fail_action=2, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Integrity Check', @step_name=N'Integrity Check USER', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_fail_action=2, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'MAINT Integrity Check', 
		@enabled=1, 
		@start_step_id=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
...
GO
DECLARE @schedule_id int
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'MAINT Integrity Check', @name=N'MAINT Integrity Check', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=1, 
		@freq_subday_type=1, 
...
-------------------------------------------------------------
--  Add Nightly FULL backup Job
-------------------------------------------------------------
USE [msdb]
GO
DECLARE @jobId BINARY(16)
EXEC  msdb.dbo.sp_add_job @job_name=N'MAINT Nightly Full', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		@notify_level_page=2, 
...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'MAINT Nightly Full', @server_name = @@SERVERNAME
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Nightly Full', @step_name=N'MAINT Nightly FULL', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_fail_action=2, 
...
@Directory = N''\\backupshare.domain.com\sql'',
@BackupType = ''FULL'',
@BlockSize = 65536,
@BufferCount = 2048,
@Verify = ''Y'',
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'MAINT Nightly Full', 
		@enabled=1, 
		@start_step_id=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
...
GO
DECLARE @schedule_id int
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'MAINT Nightly Full', @name=N'MAINT Nightly FULL', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
...
-------------------------------------------------------------
--  Add Hourly DIFF backup Job
-------------------------------------------------------------
USE [msdb]
GO
DECLARE @jobId BINARY(16)
EXEC  msdb.dbo.sp_add_job @job_name=N'MAINT Hourly DIFF', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		@notify_level_page=2, 
...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'MAINT Hourly DIFF', @server_name = @@SERVERNAME
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT Hourly DIFF', @step_name=N'MAINT Hourly DIFF', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_fail_action=2, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'MAINT Hourly DIFF', 
		@enabled=1, 
		@start_step_id=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
...
GO
DECLARE @schedule_id int
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'MAINT Hourly DIFF', @name=N'MAINT Hourly DIFF', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=8, 
...
-------------------------------------------------------------
--  Add 15M LOG backup Job
-------------------------------------------------------------
USE [msdb]
GO
DECLARE @jobId BINARY(16)
EXEC  msdb.dbo.sp_add_job @job_name=N'MAINT 15m LOG', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		@notify_level_page=2, 
...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'MAINT 15m LOG', @server_name = @@SERVERNAME
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'MAINT 15m LOG', @step_name=N'MAINT 15m LOG', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_fail_action=2, 
...
USE [msdb]
GO
EXEC msdb.dbo.sp_update_job @job_name=N'MAINT 15m LOG', 
		@enabled=1, 
		@start_step_id=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
...
GO
DECLARE @schedule_id int
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'MAINT 15m LOG', @name=N'MAINT 15m LOG', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
